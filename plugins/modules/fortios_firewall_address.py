...
def filter_firewall_address_data(json):
    option_list = ['allow_routing', 'associated_interface', 'cache_ttl',
                   ...
                   'epg_name', 'fabric_object', 'filter',
                   'fqdn', 'fsso_group', 'interface',
                   'list', 'macaddr', 'name',
                   'node_ip_only', 'obj_id', 'obj_tag',
                   'obj_type', 'organization', 'policy_group',
                   'sdn', 'sdn_addr_type', 'sdn_tag',
                   'start_ip', 'start_mac', 'sub_type',
